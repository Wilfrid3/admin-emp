					...
					<div class="app-container container-fluid d-flex align-items-stretch justify-content-between" id="kt_app_header_container">
						...
						<div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
							<a href="index-2.html" class="d-lg-none">
								<img alt="Logo" src="{{asset('assets/media/logos/nav-logo.png')}}" class="h-30px" />
							</a>
						</div>
						<!--end::Mobile logo-->
                                            ...
                                            <div class="menu-item px-3">
                                                <div class="menu-content d-flex align-items-center px-3">
                                                    ...
                                                    <div class="d-flex flex-column">
                                                        <div class="fw-bold d-flex align-items-center fs-5">{{$data->noms}}</div>
                                                        <a href="#" class="fw-semibold text-muted text-hover-primary fs-7">{{$typeuser->libelle}}</a>
                                                    </div>
                                                </div>
                                            </div>
