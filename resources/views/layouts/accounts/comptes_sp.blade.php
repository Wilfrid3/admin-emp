        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <!--begin::Title-->
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Liste des comptes</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                            ...
                            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                                <thead>
                                    <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                        ...
                                        <th class="min-w-125px">Ajouté le</th>
                                ...
                                <tbody class="text-gray-600 fw-semibold">
                                    ...
                                    @foreach ($comptes as $compte)
                                        <tr>
                                            ...
                                            <td>
                                                @if ($compte->etat == 1)
                                                    <div class="badge badge-light-success fw-bold">Activé</div>
                                                @else
                                                    <div class="badge badge-light-danger fw-bold">Désactivé</div>
                                                @endif
                                            </td>
                                            ...
                                            <td class="text-end">
                                                ...
                                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                                    <div class="menu-item px-3">
                                                        <a href="{{ route('compte-edit', ['id'=>$compte->id]) }}" class="menu-link px-3">Modifier</a>
                                                    </div>
                                                    @if ($compte->etat == 1)
                                                        <div class="menu-item px-3">
                                                            <form action="{{ route('compte-desactive', ['id'=>$compte->id]) }}" method="post">
                                                                @csrf
                                                                @method('PATCH')
                                                    ...
                                                    @else
                                                    <div class="menu-item px-3">
                                                        <form action="{{ route('compte-active', ['id'=>$compte->id]) }}" method="post">
                                                            @csrf
                                                            @method('PATCH')
                                                            <button type="submit" class="btn menu-link px-3">
                                                                Activer
                                                    ...
                                                    @endif
                                                    <div class="menu-item px-3">
                                                        <form action="{{ route('compte-delete', ['id'=>$compte->id]) }}" method="post">
                                                            @csrf
                                                            @method('DELETE')
                                                            <button type="submit" class="btn menu-link px-3">
                                                                Supprimer
