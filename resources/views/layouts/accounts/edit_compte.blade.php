        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <!--begin::Title-->
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Modifier un compte</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <li class="breadcrumb-item text-muted">Comptes</li>
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                <div class="d-flex align-items-center gap-2 gap-lg-3">
                    <a href="{{route('comptes_sp')}}" class="btn btn-sm fw-bold btn-dark">Quitter</a>
                </div>
                <!--end::Actions-->
            </div>
        </div>
            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                <div class="card">
                    ...
                    <div class="card-body py-4">
                        <form class="form w-100" novalidate="novalidate" action="{{ route('compte-update', ['id'=>$compte->id]) }}" method="POST">
                            <div class="text-center mb-11">
                                <h1 class="text-dark fw-bolder mb-3">Mettre à jour les informations d'un comptes</h1>
                                <div class="text-gray-500 fw-semibold fs-6">Informations du compte</div>
                            </div>
                            ...
                            <div class="row mb-4">
                                <div class="col-12 mb-3">
                                    <input type="text" placeholder="Entrez votre nom et prénom" name="noms" autocomplete="off" class="form-control bg-transparent" value="{{ $compte->noms }}" />
                                    <span class="text-danger">@error('noms') {{ $message }} @enderror</span>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <input type="text" placeholder="Entrez votre téléphone" name="phone" autocomplete="off" class="form-control bg-transparent" value="{{ $compte->phone }}" />
                                </div>
                                <div class="col-md-6 mb-3">
                                    <input type="email" placeholder="Entrez votre mail" name="mail" autocomplete="off" class="form-control bg-transparent" value="{{ $compte->mail }}" />
                                    <span class="text-danger">@error('mail') {{ $message }} @enderror</span>
                                </div>
                                <div class="col-12 mb-3">
                                    <input type="text" placeholder="Entrez votre adresse" name="addresse" autocomplete="off" class="form-control bg-transparent" value="{{ $compte->addresse }}" />
                                </div>
                            </div>
                            <div class="fv-row mb-4">
                                <input type="text" placeholder="Entrez votre nom d'utilisateur" name="username" autocomplete="off" class="form-control bg-transparent" value="{{ $compte->username }}" />
                                <span class="text-danger">@error('username') {{ $message }} @enderror</span>
                            </div>
                            <div class="fv-row mb-8">
                                <input type="password" placeholder="Entrez votre mot de passe" name="pasword" autocomplete="off" class="form-control bg-transparent" value="{{ $compte->valpass }}" />
