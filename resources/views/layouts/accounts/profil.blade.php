        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <!--begin::Title-->
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Gerez vos informations</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                ...
                {{-- <div class="d-flex align-items-center gap-2 gap-lg-3">
                    <a href="/comptes_sp" class="btn btn-sm fw-bold btn-dark">Quitter</a>
                </div> --}}
                <!--end::Actions-->
            </div>
        </div>
                        ...
                        <div class="card mb-5 mb-xl-10">
                            <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse" data-bs-target="#kt_account_profile_details" aria-expanded="true" aria-controls="kt_account_profile_details">
                                ...
                                <div class="card-title m-0">
                                    <h3 class="fw-bold m-0">Details Profil</h3>
                                </div>
                            </div>
                            <div id="kt_account_settings_profile_details" class="collapse show">
                                <form class="form" action="{{ route('profil-update', ['id'=>$data->id]) }}" method="POST">
                                    @csrf
                                    @method('PATCH')
                                    <div class="card-body border-top p-9">
                                        <div class="row mb-6">
                                            ...
                                            <div class="col-lg-8 fv-row">
                                                <input type="text" name="typeuser" disabled class="form-control form-control-lg form-control-solid" placeholder="Entrez votre nom" value="Administrateur" />
                                            </div>
                                        </div>
                                        <div class="row mb-6">
                                            <label class="col-lg-4 col-form-label required fw-semibold fs-6">Noms</label>
                                            <div class="col-lg-8 fv-row">
                                                <input type="text" name="noms" class="form-control form-control-lg form-control-solid" placeholder="Entrez votre nom" value="{{ $data->noms }}" />
                                                <span class="text-danger">@error('noms') {{ $message }} @enderror</span>
                                            </div>
                                        </div>
                                        <div class="row mb-6">
                                            <label class="col-lg-4 col-form-label required fw-semibold fs-6">Nom d'utilisateur</label>
                                            <div class="col-lg-8 fv-row">
                                                <input type="text" name="username" class="form-control form-control-lg form-control-solid" placeholder="Entrez votre nom d'utilisateur" value="{{ $data->username }}" />
                                        ...
                                        <div class="row mb-6">
                                            ...
                                            <div class="col-lg-8 fv-row">
                                                <input type="email" name="mail" class="form-control form-control-lg form-control-solid" placeholder="Entrez votre mail" value="{{ $data->mail }}" />
                                                <span class="text-danger">@error('mail') {{ $message }} @enderror</span>
                                            </div>
                                        </div>
                                        <div class="row mb-6">
                                            <label class="col-lg-4 col-form-label fw-semibold fs-6">Téléphone</label>
                                            <div class="col-lg-8 fv-row">
                                                <input type="text" name="phone" class="form-control form-control-lg form-control-solid" placeholder="Entrez votre numéro de téléphone" value="{{ $data->phone }}" />
                                        ...
                                        <div class="row mb-6">
                                            ...
                                            <div class="col-lg-8 fv-row">
                                                <input type="text" name="addresse" class="form-control form-control-lg form-control-solid" placeholder="Entrez votre adresse" value="{{ $data->addresse }}" />
                                                <span class="text-danger">@error('addresse') {{ $message }} @enderror</span>
                                            </div>
                                        </div>
                                        <div class="row mb-6">
                                            <label class="col-lg-4 col-form-label fw-semibold fs-6">Ajouté le</label>
                                            <div class="col-lg-8 fv-row">
                                                <input type="text" name="created_at" class="form-control form-control-lg form-control-solid" disabled value="{{ $data->created_at }}" />
                    ...
                    <div class="col-md-4 mb-3">
                        <div class="card mb-5 mb-xl-10">
                            <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse" data-bs-target="#kt_account_signin_method">
                                <div class="card-title m-0">
                                    <h3 class="fw-bold m-0">Gestion de la sécurité</h3>
                                </div>
                            </div>
                            <div class="collapse show">
                                <div class="card-body border-top p-9">
                                    <form class="form" novalidate="novalidate" action="{{ route('pass-update', ['id'=>$data->id]) }}" method="POST">
                                        @csrf
                                        @method('PATCH')
                                        <div class="row mb-1">
                                            <div class="col-lg-12">
                                                <div class="fv-row mb-3">
                                                    ...
                                                    <input type="hidden" name="valpass" value="{{ $data->valpass }}" >
                                            ...
                                            <div class="col-lg-12">
                                                <div class="fv-row mb-3">
                                                    ...
                                                    <input type="password" class="form-control form-control-lg form-control-solid" name="pasword" id="pasword" />
