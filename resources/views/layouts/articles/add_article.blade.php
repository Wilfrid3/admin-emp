    ...
    <div class="d-flex flex-column flex-column-fluid">
        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <!--begin::Title-->
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Ajouter un article</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
        ...
        <div id="kt_app_content" class="app-content flex-column-fluid">
            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                <form class="form d-flex flex-column flex-lg-row" action="{{ route('article-register') }}" method="POST"  enctype="multipart/form-data">
                    ...
                    <div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px mb-7 me-lg-10">
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                ...
                                <div class="text-muted fs-7 mb-7">Taille de l'article obligatoire.</div>
                            </div>
                        </div>
                        <div class="card card-flush py-4">
                            <div class="card-header">
                            ...
                            <div class="card-body pt-0">
                                ...
                                <select class="form-select mb-2" data-control="select2" data-placeholder="-- Selectionnez --" data-allow-clear="true" name="idTypearticle">
                                    ...
                                    @foreach ($typearticles as $typearticle)
                                        <option value="{{$typearticle->id}}">{{$typearticle->libelle}}</option>
                                    @endforeach
                                </select>
                                <span class="text-danger">@error('idTypearticle') {{ $message }} @enderror</span>
                                <div class="text-muted fs-7 mb-7">Type de l'article obligatoire.</div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="card card-flush py-4">
                                        ...
                                        <div class="card-body pt-0">
                                            <div class="mb-10 fv-row">
                                                ...
                                                <input type="text" name="libelle" class="form-control mb-2" placeholder="Entrez le libelle de l'article" value="{{ old('libelle') }}" />
                                            ...
                                            <div class="mb-10 row">
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="number" name="quantite" class="form-control mb-2" placeholder="Entrez la quantité" value="{{ old('quantite') }}" />
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="number" name="prix" class="form-control mb-2" placeholder="Entrez le prix de l'article" value="{{ old('prix') }}" />
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="number" name="oldPrix" class="form-control mb-2" placeholder="Entrez l'ancien prix de l'article" value="{{ old('oldPrix') }}" />
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="number" name="remise" class="form-control mb-2" placeholder="Entrez la remise" value="{{ old('remise') }}" />
                                                    <div class="text-muted fs-7">La remise en %.</div>
                                                </div>
                                            </div>
                                            <div class="mb-11">
                                                <label class="required form-label">Description</label>
                                                <textarea name="description" class="form-control min-h-100px mb-2" placeholder="Entrez la description">{{ old('description') }}</textarea>
                                                <span class="text-danger">@error('description') {{ $message }} @enderror</span>
                                                <div class="text-muted fs-7">Ajoutez une description à cet article.</div>
                                            </div>
                                            <div class="fv-row">
                                                <div class="form-check form-check-custom form-check-solid mb-2">
                                                    <input class="form-check-input" type="checkbox" id="kt_ecommerce_add_product_shipping_checkbox" name="etat" value="2" />
                                                    <label class="form-check-label">Publier directement l'article</label>
                                                </div>
                                            </div>
