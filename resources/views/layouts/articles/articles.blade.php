        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <!--begin::Title-->
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Liste des Articles</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                ...
                <div class="d-flex align-items-center gap-2 gap-lg-3">
                    <a href="{{route('article_add')}}" class="btn btn-sm fw-bold btn-primary">Ajouter</a>
                </div>
                <!--end::Actions-->
            </div>
        </div>
                            ...
                            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                                <thead>
                                    <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                        ...
                                        <th class="min-w-125px">Type article</th>
                                        <th class="min-w-125px">Taille article</th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <a href="#" class="symbol symbol-50px">
                                                    <span class="symbol-label" style="background-image:url('{{($article->lienImg != null) ? asset('storage/'.$article->lienImg) : asset('assets/media/svg/files/blank-image.svg')}}');"></span>
                                                </a>
                                                <div class="ms-5">
                                                    <a href="#" class="text-gray-800 text-hover-primary fs-5 fw-bold" data-kt-ecommerce-product-filter="product_name">{{$article->libelle}}</a>
                                                </div>
                                            </div>
                                        </td>
                                        <td>{{$article->type}}</td>
                                        ...
                                        <td class="text-end">
                                            ...
                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                                @if ($article->etat == 1 || $article->etat == 3)
                                            ...
                                            @elseif ($article->etat == 2)
                                            <div class="menu-item px-3">
                                                <form action="{{ route('article-block', ['id'=>$article->id]) }}" method="post">
                                                    @csrf
                                                    @method('PATCH')
                                                    <button type="submit" class="btn menu-link px-3 w-100">
                                                        Suspendre
