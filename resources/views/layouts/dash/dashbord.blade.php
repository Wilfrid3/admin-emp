        ...
        <div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper hover-scroll-overlay-y my-5" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_app_sidebar_logo, #kt_app_sidebar_footer" data-kt-scroll-wrappers="#kt_app_sidebar_menu" data-kt-scroll-offset="5px" data-kt-scroll-save-state="true">
            ...
            <div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
                ...
                <div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
                    ...
                    @if ($typeuser->id == 1)
                        <div class="menu-item">
                            <a class="menu-link active" href="/dashbord">
    ...
    <div class="d-flex flex-column flex-column-fluid">
        ...
        <div id="kt_app_content" class="app-content flex-column-fluid">
            <div id="kt_app_content_container" class="app-container container-fluid">
                ...
                @if ($data->idTypecompte == 2)
                    <div class="row g-5 g-xl-10 mb-5 mb-xl-10">
                        <div class="col-md-12 mb-3">
                            <div class="card card-flush h-md-100">
                                <div class="card-header pt-7">
                                    <h3 class="card-title align-items-start flex-column">
                                        <span class="card-label fw-bold text-gray-800">Rendez-vous récents</span>
                                        ...
                                        <table class="table table-row-dashed align-middle gs-0 gy-3 my-0">
                                            <thead>
                                                <tr class="fs-7 fw-bold text-gray-400 border-bottom-0">
                                                    <th class="p-0 pb-3 min-w-120px text-start">SERVICE</th>
                                                    <th class="p-0 pb-3 min-w-120px text-start">CLIENT</th>
                                                    <th class="p-0 pb-3 min-w-75px text-start">DATE</th>
                                                    <th class="p-0 pb-3 min-w-75px text-start">HEURE</th>
                                                    <th class="p-0 pb-3 text-start ">ETAT</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                @if (count($books) <= 0)
                                                    <tr>
                                                        <td colspan="4" class="text-center pe-0">Aucun rendez-vous trouvé</td>
                                                    </tr>
                                                @else
                                                    @foreach ($books as $book)
                                                        <tr>
                                                            <td>
                                                                <div class="d-flex align-items-center">
                                                                    <div class="symbol symbol-50px me-3">
                                                                        <img src="{{asset('storage/'.$book->lienImgserv)}}" class="" alt="" />
                                                                    </div>
                                                                    <div class="d-flex justify-content-start flex-column">
                                                                        <a href="#" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">{{$book->libserv}}</a>
                                                                        <span class="text-gray-400 fw-semibold d-block fs-7">{{$book->typeserv}} - €{{$book->prixserv}} / {{$book->dureeserv}}</span>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            ...
                                                            <td>{{$book->daterdv}}</td>
                                                            <td>{{$book->heureDeb}} - {{$book->heureFin}}</td>
                                                            <td>
                                                                @if ($book->etat == 0)
                        ...
                        <div class="col-md-12 mb-3">
                            <div class="card card-flush h-md-100">
                                <div class="card-header pt-7">
                                    <h3 class="card-title align-items-start flex-column">
                                        <span class="card-label fw-bold text-gray-800">Commandes récentes</span>
                                ...
                                <div class="card-body pt-6">
                                    <div class="table-responsive">
                                        <table class="table table-row-dashed align-middle gs-0 gy-3 my-0">
                                            <thead>
                                                <tr class="fs-7 fw-bold text-gray-400 border-bottom-0">
                                                    <th class="p-0 pb-3 min-w-120px text-start">ARTICLE</th>
                                                    <th class="p-0 pb-3 min-w-120px text-start">CLIENT</th>
                                                    <th class="p-0 pb-3 min-w-75px text-start">REFERENCE</th>
                                                    <th class="p-0 pb-3 min-w-75px text-start">ADRESSE LIVRAISON</th>
                                                    <th class="p-0 pb-3 text-start ">ETAT</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                @if (count($orders) <= 0)
                                                    <tr>
                                                        <td colspan="4" class="text-center pe-0">Aucune commande trouvée</td>
                                                    </tr>
                                                @else
                                                    @foreach ($orders as $order)
                                                        <tr>
                                                            <td>
                                                                <div class="d-flex align-items-center">
                                                                    <div class="symbol symbol-50px me-3">
                                                                        <img src="{{asset('storage/'.$order->lienImgarti)}}" class="" alt="" />
                                                                    </div>
                                                                    <div class="d-flex justify-content-start flex-column">
                        ...
                        <div class="col-md-12 mb-3">
                            <div class="card card-flush h-md-100">
                                <div class="card-header pt-7">
                                    <h3 class="card-title align-items-start flex-column">
                                        <span class="card-label fw-bold text-gray-800">Transactions récentes</span>
                                ...
                                <div class="card-body pt-6">
                                    <div class="table-responsive">
                                        <table class="table table-row-dashed align-middle gs-0 gy-3 my-0">
                                            <thead>
                                                <tr class="fs-7 fw-bold text-gray-400 border-bottom-0">
                                                    <th class="p-0 pb-3 min-w-120px text-start">REFERENCE</th>
                                                    <th class="p-0 pb-3 min-w-120px text-start">SERVICE</th>
                                                    <th class="p-0 pb-3 min-w-120px text-start">CLIENT</th>
                                                    <th class="p-0 pb-3 text-start ">ETAT</th>
                                                </tr>
                                            ...
                                            <tbody>
                                                @if (count($transactions) <= 0)
                                                    <tr>
                                                        <td colspan="4" class="text-center pe-0">Aucune transaction trouvée</td>
                                                    </tr>
                                                @else
                                                    @foreach ($transactions as $transaction)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="d-flex align-items-center">
                                                                    <div class="symbol symbol-50px me-3">
                                                                        <img src="{{asset('storage/'.$transaction->lienImgserv)}}" class="" alt="" />
                                                                    </div>
                                                                    <div class="d-flex justify-content-start flex-column">
                                                                        <a href="#" class="text-gray-800 text-hover-primary fs-5 fw-bold" data-kt-ecommerce-product-filter="product_name">{{$transaction->libserv}}</a>
                                                                        <span class="text-gray-400 fw-semibold d-block fs-7">{{$transaction->typeserv}} - €{{$transaction->prixserv}} / {{$transaction->dureeserv}}</span>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            <td class="d-flex align-items-center">
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="card card-flush h-md-100">
                                <div class="card-header pt-7">
                                    <h3 class="card-title align-items-start flex-column">
                                        <span class="card-label fw-bold text-gray-800">Services récents</span>
                                        <span class="text-gray-400 mt-1 fw-semibold fs-6">Services récements ajoutés</span>
                                    </h3>
                                    <div class="card-toolbar">
                                        @if (count($services) <= 0)
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-row-dashed align-middle gs-0 gy-3 my-0">
                                            <thead>
                                                <tr class="fs-7 fw-bold text-gray-400 border-bottom-0">
                                                    <th class="p-0 pb-3 min-w-120px text-start">SERVICE</th>
                                                    <th class="p-0 pb-3 min-w-75px text-end">DUREE</th>
                                                    <th class="p-0 pb-3 min-w-75px text-end">PRIX</th>
                                                    <th class="p-0 pb-3 text-end ">ETAT</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                @if (count($services) <= 0)
                                                    <tr>
                                                        <td colspan="4" class="text-center pe-0">Aucun service trouvé</td>
                                                    </tr>
                                                @else
                                                    @foreach ($services as $service)
                                                        <tr>
                                                            <td>
                                                                <div class="d-flex align-items-center">
                                                                    <div class="symbol symbol-50px me-3">
                                                                        <img src="{{asset('storage/'.$service->lienImg)}}" class="" alt="" />
                                                                    </div>
                                                                    <div class="d-flex justify-content-start flex-column">
                                                                        <a href="#" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">{{$service->libelle}}</a>
                                                                        <span class="text-gray-400 fw-semibold d-block fs-7">{{$service->type}}</span>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            <td class="text-end pe-0">{{$service->duree}}</td>
                                                            <td class="text-end pe-0">
                                                                <span class="text-gray-600 fw-bold fs-6">€ {{$service->prix}}</span>
                                                            </td>
                                                            <td class="text-end pe-0">
                                                                @if ($service->etat == 1)
                                                                    <div class="badge badge-secondary fw-bold">Crée</div>
                                                                @elseif ($service->etat == 2) 
                                                                    <div class="badge badge-light-success fw-bold">Publié</div>
                                                                @elseif ($service->etat == 3) 
                                                                    <div class="badge badge-light-danger fw-bold">Suspendu</div>
                                                                @endif
                                                            </td>
                                                        </tr>
                                                    @endforeach
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="card card-flush h-md-100">
                                <div class="card-header pt-7">
                                    <h3 class="card-title align-items-start flex-column">
                                        <span class="card-label fw-bold text-gray-800">Articles récents</span>
                                        <span class="text-gray-400 mt-1 fw-semibold fs-6">Articles récements ajoutés</span>
                                    </h3>
                                    <div class="card-toolbar">
                                        @if (count($articles) <= 0)
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-row-dashed align-middle gs-0 gy-3 my-0">
                                            <thead>
                                                <tr class="fs-7 fw-bold text-gray-400 border-bottom-0">
                                                    <th class="p-0 pb-3 min-w-120px text-start">Article</th>
                                                    <th class="p-0 pb-3 min-w-75px text-end">Quantité</th>
                                                    <th class="p-0 pb-3 min-w-75px text-end">PRIX</th>
                                                    <th class="p-0 pb-3 text-end ">ETAT</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                @if (count($articles) <= 0)
                                                    <tr>
                                                        <td colspan="4" class="text-center pe-0">Aucun article trouvé</td>
                                                    </tr>
                                                @else
                                                    @foreach ($articles as $article)
                                                        <tr>
                                                            <td>
                                                                <div class="d-flex align-items-center">
                                                                    <div class="symbol symbol-50px me-3">
                                                                        <img src="{{asset('storage/'.$article->lienImg)}}" class="" alt="" />
                                                                    </div>
                                                                    <div class="d-flex justify-content-start flex-column">
                                                                        <a href="#" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">{{$article->libelle}}</a>
                                                                        <span class="text-gray-400 fw-semibold d-block fs-7">{{$article->type}}</span>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            <td class="text-end pe-0">{{$article->quantite}}</td>
                                                            <td class="text-end pe-0">
                                                                <span class="text-gray-600 fw-bold fs-6">€ {{$article->prix}}</span>
                                                            </td>
                                                            <td class="text-end pe-0">
                                                                @if ($article->etat == 1)
                                                                    <div class="badge badge-secondary fw-bold">Crée</div>
