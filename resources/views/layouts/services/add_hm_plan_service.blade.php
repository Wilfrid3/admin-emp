        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <!--begin::Title-->
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Ajouter des horaires à la planification du service</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                ...
                <div class="d-flex align-items-center gap-2 gap-lg-3">
                    <a href="{{ route('plans', ['id'=>$idserv]) }}" class="btn btn-sm fw-bold btn-dark">Terminer</a>
                </div>
                <!--end::Actions-->
            </div>
        </div>
            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                <div class="card">
                    ...
                    <div class="card-body py-4">
                        <form class="form w-100" novalidate="novalidate" action="{{ route('hm-plan-register') }}" method="POST">
                            <div class="text-center mb-11">
                                <h1 class="text-dark fw-bolder mb-3">Horaires de la planification</h1>
                                <div class="text-gray-500 fw-semibold fs-6">Ajouter des horaires à la planification</div>
                            </div>
