        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <!--begin::Title-->
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Ajouter une planification au service</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                ...
                <div class="d-flex align-items-center gap-2 gap-lg-3">
                    <a href="{{ route('plans', ['id'=>$id]) }}" class="btn btn-sm fw-bold btn-dark">Retour</a>
                </div>
                <!--end::Actions-->
            </div>
        </div>
            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                <div class="card">
                    ...
                    <div class="card-body py-4">
                        <form class="form w-100" novalidate="novalidate" action="{{ route('plan-register') }}" method="POST">
                            <div class="text-center mb-11">
                                <h1 class="text-dark fw-bolder mb-3">Nouvelle planification</h1>
                                <div class="text-gray-500 fw-semibold fs-6">Entrez les informations de la nouvelle planification</div>
                            </div>
                            ...
                            <div class="row mb-4">
                                <div class="col-12 mb-3">
                                    ...
                                    <input type="date" placeholder="Entrez la date" name="datePlaning" autocomplete="off" class="form-control bg-transparent" value="{{ old('datePlaning') }}" />
                                    <input type="hidden" name="idService" value="{{ $id }}">
                                    <span class="text-danger">@error('datePlaning') {{ $message }} @enderror</span>
                                </div>
                            </div>
