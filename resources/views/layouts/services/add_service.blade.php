    ...
    <div class="d-flex flex-column flex-column-fluid">
        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <!--begin::Title-->
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Ajouter un service</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
        ...
        <div id="kt_app_content" class="app-content flex-column-fluid">
            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                <form class="form d-flex flex-column flex-lg-row" action="{{ route('service-register') }}" method="POST"  enctype="multipart/form-data">
                            ...
                            <div class="card-body pt-0">
                                ...
                                <select class="form-select mb-2" data-control="select2" data-placeholder="-- Selectionnez --" data-allow-clear="true" name="idTypeservice">
                                    ...
                                    @foreach ($typeservices as $typeservice)
                                        <option value="{{$typeservice->id}}">{{$typeservice->libelle}}</option>
                                    @endforeach
                                </select>
                                    ...
                                    <div class="card card-flush py-4">
                                        ...
                                        <div class="card-body pt-0">
                                            <div class="mb-10 fv-row">
                                                ...
                                                <input type="text" name="libelle" class="form-control mb-2" placeholder="Entrez le libelle du service" value="{{ old('libelle') }}" />
                                            ...
                                            <div class="mb-10 row">
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="number" name="prix" class="form-control mb-2" placeholder="Entrez le prix du service" value="{{ old('prix') }}" />
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="number" name="oldPrix" class="form-control mb-2" placeholder="Entrez l'ancien prix du service" value="{{ old('oldPrix') }}" />
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="text" name="duree" class="form-control mb-2" placeholder="Entrez la durée" value="{{ old('duree') }}" />
                                            ...
                                            <div class="fv-row">
                                                <div class="form-check form-check-custom form-check-solid mb-2">
                                                    ...
                                                    <label class="form-check-label">Publier directement le service</label>
                                                </div>
                                            </div>
