        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <!--begin::Title-->
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Gestion des horaires de la planification</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <li class="breadcrumb-item text-muted">
                            <a href="/services" class="text-muted text-hover-primary">Services</a>
                        </li>
                        <li class="breadcrumb-item">
                            <span class="bullet bg-gray-400 w-5px h-2px"></span>
                        </li>
                        <li class="breadcrumb-item text-muted">
                            <a href="/services" class="text-muted text-hover-primary">Planing</a>
                        </li>
                        <li class="breadcrumb-item">
                            <span class="bullet bg-gray-400 w-5px h-2px"></span>
                        </li>
                        <li class="breadcrumb-item text-muted">Horaires</li>
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                <div class="d-flex align-items-center gap-2 gap-lg-3">
                    <a href="{{ route('plans', ['id'=>$idserv]) }}" class="btn btn-sm fw-bold btn-dark">Retour</a>
                </div>
                <!--end::Actions-->
            </div>
        </div>
                ...
                <div class="row">
                        ...
                        <div class="card card-flush py-4">
                            <div class="card-header">
                                <div class="card-title">
                                    <h2>Liste des horaires de la planification</h2>
                                </div>
                            </div>
                                        ...
                                        <tbody class="text-gray-600 fw-semibold">
                                            ...
                                            @foreach ($horaires as $horaire)
                                                <tr>
                                                    ...
                                                    <td>{{$horaire->heureDeb}}</td>
                                                    <td>{{$horaire->heureFin}}</td>
                                                    <td>{{$horaire->created_at}}</td>
                                                    <td class="text-end">
                                                        <form action="{{ route('horaire-delete', ['id'=>$horaire->id]) }}" method="post">
                                                            @csrf
                                                            @method('DELETE')
                    ...
                    <div class="col-md-3 mb-3">
                        <div class="card card-flush py-4">
                            <div class="card-header">
                                <div class="card-title">
                                    <h2>Ajout des horaires</h2>
                                </div>
                            </div>
                            <div class="card-body pt-0">
                                <form class="form w-100" novalidate="novalidate" action="{{ route('hm-register') }}" method="POST">
                                    @csrf
                                    <div class="row mb-4">
                                        <div class="col-md-12 mb-3">
                                            <label class="required form-label">Heure de début</label>
                                            <input type="time" placeholder="Entrez l'heure de début" name="heureDeb" autocomplete="off" class="form-control bg-transparent" value="{{ old('heureDeb') }}" />
                                            <input type="hidden" name="idPlaning" value="{{ $id }}">
                                            <span class="text-danger">@error('heureDeb') {{ $message }} @enderror</span>
                                        </div>
                                        <div class="col-md-12 mb-3">
                                            <label class="required form-label">Heure de fin</label>
                                            <input type="time" placeholder="Entrez l'heure de fin" name="heureFin" autocomplete="off" class="form-control bg-transparent" value="{{ old('heureFin') }}" />
                                            <span class="text-danger">@error('heureFin') {{ $message }} @enderror</span>
                                        </div>
                                    </div>
