        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <!--begin::Title-->
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Informations détaillés</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <li class="breadcrumb-item text-muted">Planing</li>
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                <div class="d-flex align-items-center gap-2 gap-lg-3">
                    <a href="{{route('planing')}}" class="btn btn-sm fw-bold btn-dark">Retour</a>
                </div>
                <!--end::Actions-->
            </div>
        </div>
                ...
                <div class="card">
                    <div class="card-body p-lg-20 pb-lg-0">
                        <div class="d-flex flex-column flex-xl-row">
                            <div class="flex-column flex-lg-row-auto w-100 w-xl-300px mb-10 me-xl-10">
                                <div class="mb-16">
                                    <div class="px-9 pt-7 card-rounded h-250px w-100 bg-primary">
                                        <div class="d-flex flex-stack">
                                            <h3 class="m-0 text-white fw-bold fs-3">Détail de la planification</h3>
                                            <div class="ms-1"></div>
                                        </div>
                                        <div class="d-flex text-center flex-column text-white pt-8">
                                            <span class="fw-semibold fs-7">Date</span>
                                            <span class="fw-bold fs-2x pt-1">{{$plan->datePlaning}}</span>
                                        </div>
                                    </div>
                                        ...
                                        @foreach ($horaires as $horaire)
                                            <div class="d-flex align-items-center">
                                                <div class="d-flex align-items-center flex-wrap w-100">
                                                    <div class="mb-4 pe-3 flex-grow-1">
                                                        <a href="#" class="fs-5 text-gray-800 text-hover-primary fw-bold">{{($horaire->heureDeb)}} - {{$horaire->heureFin}}</a>
                                                        <div class="text-gray-400 fw-semibold fs-7">Plage horaire</div>
                                                    </div>
                                                </div>
                                            </div>
                                        @endforeach
                                    ...
                                    <div class="mb-8">
                                        <div class="d-flex flex-wrap mb-3">
                                            <div class="me-9 my-1">
                                                ...
                                                <span class="fw-bold text-gray-400">{{$typeservice->libelle}}</span>
                                            </div>
                                            <div class="me-9 my-1">
                                                <span class="fw-bold text-gray-400">{{$service->duree}}</span>
                                            </div>
                                            <div class="my-1">
                                                <span class="fw-bold text-gray-400">€ {{$service->prix}}</span>
                                            </div>
                                        </div>
                                        <a href="#" class="text-dark text-hover-primary fs-2 fw-bold">{{$service->libelle}}</a>
                                        <div class="overlay mt-4">
                                            <div class="bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-350px" style="background-image:url({{asset('storage/'.$service->lienImg)}})"></div>
                                        </div>
                                    </div>
