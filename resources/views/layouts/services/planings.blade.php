        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <!--begin::Title-->
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Liste des Planifications</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                                ...
                                <tbody class="text-gray-600 fw-semibold">
                                    ...
                                    @foreach ($plans as $plan)
                                        <tr>
                                            ...
                                            <td>{{$plan->datePlaning}}</td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <a href="#" class="symbol symbol-50px">
                                                        <span class="symbol-label" style="background-image:url({{($plan->lienImg != null) ? asset('storage/'.$plan->lienImg) : asset('assets/media/svg/files/blank-image.svg')}});"></span>
                                                    </a>
                                                    <div class="ms-5">
                                                        <a href="#" class="text-gray-800 text-hover-primary fs-5 fw-bold mb-1" data-kt-ecommerce-product-filter="product_name">{{$plan->libelle}}</a>
                                                        <p class="text-gray-500 fs-5 mb-0">{{$plan->duree}} / {{$plan->prix}} €</p>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>{{$plan->created_at}}</td>
                                            <td class="text-center">
                                                <a href="{{ route('plan-view', ['id'=>$plan->id]) }}" class="btn btn-sm btn-icon btn-bg-light btn-active-color-primary w-30px h-30px">
