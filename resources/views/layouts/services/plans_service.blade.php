        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <!--begin::Title-->
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Liste des planifications du service</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                ...
                <div class="d-flex align-items-center gap-2 gap-lg-3">
                    ...
                    <a href="{{ route('plan-add', ['id'=>$id]) }}" class="btn btn-sm fw-bold btn-primary">Ajouter</a>
                </div>
                <!--end::Actions-->
            </div>
        </div>
                                    ...
                                    @foreach ($plans as $plan)
                                        <tr>
                                            ...
                                            <td class="text-end d-flex justify-content-end">
                                                <a href="{{ route('hs-plans', ['id'=>$plan->id, 'idserv'=>$id]) }}" class="btn btn-dark btn-active-dark btn-sm m-2"> Horaires</a>
