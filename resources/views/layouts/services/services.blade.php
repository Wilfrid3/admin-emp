        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <!--begin::Title-->
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Liste des Services</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                ...
                <div class="d-flex align-items-center gap-2 gap-lg-3">
                    <a href="{{route('service_add')}}" class="btn btn-sm fw-bold btn-primary">Ajouter</a>
                </div>
                <!--end::Actions-->
            </div>
        </div>
                                ...
                                <tbody class="text-gray-600 fw-semibold">
                                    ...
                                    @foreach ($services as $service)
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <a href="#" class="symbol symbol-50px">
                                                        <span class="symbol-label" style="background-image:url('{{($service->lienImg != null) ? asset('storage/'.$service->lienImg) : asset('assets/media/svg/files/blank-image.svg')}}');"></span>
                                                    </a>
                                                    <div class="ms-5">
                                                        <a href="#" class="text-gray-800 text-hover-primary fs-5 fw-bold" data-kt-ecommerce-product-filter="product_name">{{$service->libelle}}</a>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>{{$service->type}}</td>
                                            ...
                                            <td class="text-end">
                                                <a href="{{ route('plans', ['id'=>$service->id]) }}" class="btn btn-dark btn-active-dark btn-sm m-2"> 
                                                ...
                                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                                    @if ($service->etat == 1 || $service->etat == 3)
                                                    ...
                                                    @elseif ($service->etat == 2)
                                                        <div class="menu-item px-3">
                                                            <form action="{{ route('service-block', ['id'=>$service->id]) }}" method="post">
                                                                @csrf
                                                                @method('PATCH')
                                                                <button type="submit" class="btn menu-link px-3 w-100">
                                                                    Suspendre
